...
export default function Home() {
    ...
    useEffect((id) => {
        axios.get('https://to-do-list-app-3oo.onrender.com/get/' + id)
    ...
    const handleEdit = (id) => {
        axios.put('https://to-do-list-app-3oo.onrender.com/update/' + id)
            .then(result => {
    ...
    const handleDelete = (id) => {
        axios.delete('https://to-do-list-app-3oo.onrender.com/delete/' + id)
            .then(result => {
                window.location.reload()
            })
            .catch(err => console.log(err))
